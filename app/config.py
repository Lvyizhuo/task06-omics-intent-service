...
class Settings:
    ...
    api_timeout: float = field(default_factory=lambda: float(os.getenv("API_TIMEOUT", "60")))
    alphafold3_timeout: float = field(default_factory=lambda: float(os.getenv("ALPHAFOLD3_TIMEOUT", "600")))
